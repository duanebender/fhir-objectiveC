...
@property (nonatomic, retain) CodeableConcept *role; //Indicates specific responsibility of an individual within the care plan. E.g. "Primary physician", "Team coordinator", "Caregiver", etc.
@property (nonatomic, retain) Resource *member; //The specific person or organization who is participating/expected to participate in the care plan. (Practitioner|RelatedPerson|Patient|Organization)
