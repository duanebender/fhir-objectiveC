...
@property (nonatomic, retain) FHIRResource *member; //The specific person or organization who is participating/expected to participate in the care plan. (Practitioner|RelatedPerson|Patient|Organization)
