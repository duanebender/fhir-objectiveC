...
- (id)init
{
    ...
    if (self) {
        ...
        _container = [[FHIRCodeableConcept alloc] init];
...
- (NSDictionary *)generateAndReturnDictionary
{
    _packageDictionary.dataForResource = [NSDictionary dictionaryWithObjectsAndKeys:
                                           ...
                                           [FHIRExistanceChecker generateArray:_content], @"content",
                                           nil];
...
- (void)packageParser:(NSDictionary *)dictionary
{
    ...
    {
        FHIRContent *tempCN = [[FHIRContent alloc] init];
