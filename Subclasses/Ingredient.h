...
@property (nonatomic, retain) Resource *item; //The actual ingredient - either a substance (simple ingredient) or another medication. (Substance|Medication)
@property (nonatomic, retain) Ratio *amount; //Specifies how many (or how much) of the items there are in this Medication. E.g. 250 mg per tablet.
