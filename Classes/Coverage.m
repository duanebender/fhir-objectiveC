...
- (id)init
{
    ...
    if (self) {
        ...
        _issuer = [[Resource alloc] init];
        _period = [[Period alloc] init];
        _type = [[Coding alloc] init];
        _identifier = [[Identifier alloc] init];
        _group = [[Identifier alloc] init];
        _plan = [[Identifier alloc] init];
        _subplan = [[Identifier alloc] init];
        _dependent = [[NSNumber alloc] init];
        _sequence = [[NSNumber alloc] init];
        _subscriber = [[Subscriber alloc] init];
    }
    return self;
}
